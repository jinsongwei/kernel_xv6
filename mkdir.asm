...
printint(int fd, int xx, int base, int sgn)
{
 ...
 402:	0f b6 80 70 08 00 00 	movzbl 0x870(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 563:	75 27                	jne    58c <printf+0x120>
          s = "(null)";
 565:	c7 45 e4 66 08 00 00 	movl   $0x866,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 633:	a1 8c 08 00 00       	mov    0x88c,%eax
...
free(void *ap)
{
 ...
 6f4:	a3 8c 08 00 00       	mov    %eax,0x88c
}
 6f9:	c9                   	leave  
 6fa:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 747:	e8 d8 fe ff ff       	call   624 <free>
  return freep;
 74c:	a1 8c 08 00 00       	mov    0x88c,%eax
}
 751:	c9                   	leave  
 752:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 765:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 768:	a1 8c 08 00 00       	mov    0x88c,%eax
 76d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 770:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 774:	75 23                	jne    799 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 776:	c7 45 f0 84 08 00 00 	movl   $0x884,-0x10(%ebp)
 77d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 780:	a3 8c 08 00 00       	mov    %eax,0x88c
 785:	a1 8c 08 00 00       	mov    0x88c,%eax
 78a:	a3 84 08 00 00       	mov    %eax,0x884
    base.s.size = 0;
 78f:	c7 05 88 08 00 00 00 	movl   $0x0,0x888
 796:	00 00 00 
  }
 ...
 7ec:	a3 8c 08 00 00       	mov    %eax,0x88c
      return (void*)(p + 1);
 ...
 7f7:	eb 38                	jmp    831 <malloc+0xde>
    ...
    if(p == freep)
 7f9:	a1 8c 08 00 00       	mov    0x88c,%eax
